  ...
  try {
    ...
    const prompt =
      interaction.commandName === 'roast'
        ...
        : `Praise the fictional character "${characterName}" from the show "${showName}" as if they are the most amazing being ever. Be heartfelt, and funny. Make it two to four sentences at most.`;
